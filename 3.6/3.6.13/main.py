...
class InitForm(QWidget):
    ...
    def UI_Init(self):
        ...
        self.ui.pushButton_CleanRecevice.clicked.connect(self.pushButton_CleanRecevice)
        ...
        if self.ui.checkBox_HexSend.checkState():
            ...
            while send_text != '':
                try:
                    ...
                    # QtWidgets.QMessageBox.warning(self,'错误信息','请正确输入16进制数据')
                    return
                # print(send_list)   
...
# 00 07 00 00 80 01 00
    ...
    def pushButton_CleanRecevice(self):
        self.ReceiveLength = 0
