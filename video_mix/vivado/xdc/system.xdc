...
# 0_792_CFG1_CTL
set_property PACKAGE_PIN AG14 [get_ports {gpio_tri_io[22]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_tri_io[22]}]
# 1_792_CFG1_CTL
set_property PACKAGE_PIN AH14 [get_ports {gpio_tri_io[23]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_tri_io[23]}]
# 0_9296_CFG1_CTL
set_property PACKAGE_PIN AC11 [get_ports {gpio_tri_io[24]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_tri_io[24]}]
# 1_9296_CFG1_CTL  VALID
set_property PACKAGE_PIN AB11 [get_ports {gpio_tri_io[25]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_tri_io[25]}]

# PL_LOCK_LED
set_property PACKAGE_PIN AF11 [get_ports {gpio_tri_io[26]}]
