...
HD_PWD='D:/workdir/pic_lwip_udp/ov5640_udp_pc_7020/ov5640_udp_pc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ov5640_udp_pc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ov5640_udp_pc.tcl -notrace
