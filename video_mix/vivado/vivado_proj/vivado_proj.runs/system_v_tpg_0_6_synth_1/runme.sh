...
HD_PWD='D:/workdir/pic_lwip_udp/video_mix/vivado/vivado_proj/vivado_proj.runs/system_v_tpg_0_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_v_tpg_0_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_v_tpg_0_6.tcl
