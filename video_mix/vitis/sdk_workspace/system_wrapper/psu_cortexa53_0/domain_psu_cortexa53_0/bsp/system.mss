...
BEGIN OS
 ...
 PARAMETER stdin = processer_ss_axi_uartlite_0
 PARAMETER stdout = processer_ss_axi_uartlite_0
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = ch_0_axis_passthrough_mon_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_switch
 PARAMETER DRIVER_VER = 1.3
 PARAMETER HW_INSTANCE = ch_0_axis_switch_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 8.2
 PARAMETER HW_INSTANCE = ch_0_v_tc_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_tpg
 PARAMETER DRIVER_VER = 8.2
 PARAMETER HW_INSTANCE = ch_0_v_tpg_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_tpg
 PARAMETER DRIVER_VER = 8.2
 PARAMETER HW_INSTANCE = ch_0_v_tpg_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_passthrough_monitor
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ch_1_axis_passthrough_mon_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_switch
 PARAMETER DRIVER_VER = 1.3
 PARAMETER HW_INSTANCE = ch_1_axis_switch_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 8.2
 PARAMETER HW_INSTANCE = ch_1_v_tc_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_tpg
 PARAMETER DRIVER_VER = 8.2
 PARAMETER HW_INSTANCE = ch_1_v_tpg_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_tpg
 PARAMETER DRIVER_VER = 8.2
 PARAMETER HW_INSTANCE = ch_1_v_tpg_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = AXI_LITE_REG
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = processer_ss_AXI_LITE_REG_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = uartlite
 PARAMETER DRIVER_VER = 3.4
 PARAMETER HW_INSTANCE = processer_ss_axi_uartlite_0
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = vdma_ss_axi_vdma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.7
 PARAMETER HW_INSTANCE = vdma_ss_axi_vdma_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.7
 PARAMETER HW_INSTANCE = vdma_ss_axi_vdma_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_passthrough_monitor
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = vdma_ss_axis_passthrough_mon_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = clk_wiz
 PARAMETER DRIVER_VER = 1.3
 PARAMETER HW_INSTANCE = vid_out_ss_clk_wiz_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 8.2
 PARAMETER HW_INSTANCE = vid_out_ss_v_tc_0
END
...
BEGIN LIBRARY
 ...
 PARAMETER mem_size = 520000000
 PARAMETER memp_n_pbuf = 4096
 PARAMETER n_rx_descriptors = 512
 PARAMETER pbuf_pool_bufsize = 61449
