...
(* mark_debug = "true" *)    output  reg  [31:0]  src_ip       //接收到的源IP地址
    );
...
(* mark_debug = "true" *)reg    [47:0]  des_mac_t ; //接收到的目的MAC地址
(* mark_debug = "true" *)reg    [31:0]  des_ip_t  ; //接收到的目的IP地址
(* mark_debug = "true" *)reg    [47:0]  src_mac_t ; //接收到的源MAC地址
(* mark_debug = "true" *)reg    [31:0]  src_ip_t  ; //接收到的源IP地址
(* mark_debug = "true" *)reg    [15:0]  eth_type  ; //以太网类型
(* mark_debug = "true" *)reg    [15:0]  op_data   ; //操作码
