...
HD_PWD='D:/workdir/pic_lwip_udp/video_mix/vivado/vivado_proj/vivado_proj.runs/system_axis_passthrough_mon_0_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axis_passthrough_mon_0_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axis_passthrough_mon_0_8.tcl
